...
void selection_sort(int arr[],int n){
    ...
    cout<<" Number of Swaps = "<<no_of_swap<<endl;
    cout<<" Number of Comparison = "<<no_of_comp<<endl;
    cout<<" [InPlace Sorting Algotrithm Used]"<<endl;
}
...
Time Complexity Of Selection Sort:
    ...
    element from the array.We have to go through all the elements of the
    array to find the minimum element.
    With reference to the above code of Selection Sort , first we will
    search for minimum element in array of size n ,then in the same array of size n-1 , and so on till the array of size 1.
